...
#### Problem 1: Create a code chunk below showing how to calculate the median mpg without evaluating the expression [Helpful guide](http://yihui.name/knitr/options/)
```{r}
# Your code goes here
